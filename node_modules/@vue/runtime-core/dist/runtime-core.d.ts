...
export declare type ComponentOptionsWithArrayProps<PropNames extends string = string, RawBindings = {}, D = {}, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = EmitsOptions, EE extends string = string, Props = Readonly<{
    [key in PropNames]?: any;
}>> = ComponentOptionsBase<Props, RawBindings, D, C, M, E, EE> & {
    props: PropNames[];
} & ThisType<ComponentPublicInstance<Props, RawBindings, D, C, M, E>>;

export declare type ComponentOptionsWithObjectProps<PropsOptions = ComponentObjectPropsOptions, RawBindings = {}, D = {}, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = EmitsOptions, EE extends string = string, Props = Readonly<ExtractPropTypes<PropsOptions>>> = ComponentOptionsBase<Props, RawBindings, D, C, M, E, EE> & {
    props: PropsOptions;
} & ThisType<ComponentPublicInstance<Props, RawBindings, D, C, M, E>>;

export declare type ComponentOptionsWithoutProps<Props = {}, RawBindings = {}, D = {}, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = EmitsOptions, EE extends string = string> = ComponentOptionsBase<Props, RawBindings, D, C, M, E, EE> & {
    props?: undefined;
} & ThisType<ComponentPublicInstance<{}, RawBindings, D, C, M, E, Readonly<Props>>>;
...
D = {}, // return from data()
C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = {}, PublicProps = P> = {
...
export declare function defineComponent<Props = {}, RawBindings = {}, D = {}, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = Record<string, any>, EE extends string = string>(options: ComponentOptionsWithoutProps<Props, RawBindings, D, C, M, E, EE>): {
    new (): ComponentPublicInstance<Props, RawBindings, D, C, M, E, VNodeProps & Props>;
} & ComponentOptionsWithoutProps<Props, RawBindings, D, C, M, E, EE>;

export declare function defineComponent<PropNames extends string, RawBindings, D, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = Record<string, any>, EE extends string = string>(options: ComponentOptionsWithArrayProps<PropNames, RawBindings, D, C, M, E, EE>): {
...
export declare function defineComponent<PropsOptions extends Readonly<ComponentPropsOptions>, RawBindings, D, C extends ComputedOptions = {}, M extends MethodOptions = {}, E extends EmitsOptions = Record<string, any>, EE extends string = string>(options: ComponentOptionsWithObjectProps<PropsOptions, RawBindings, D, C, M, E, EE>): {
    new (): ComponentPublicInstance<ExtractPropTypes<PropsOptions>, RawBindings, D, C, M, E, VNodeProps & ExtractPropTypes<PropsOptions, false>>;
...
export declare interface FunctionalComponent<P = {}, E extends EmitsOptions = Record<string, any>> extends SFCInternalOptions {
...
declare interface LegacyOptions<Props, D, C extends ComputedOptions, M extends MethodOptions> {
    [key: string]: any;
...
declare type PropMethod<T> = T extends (...args: any) => any ? {
    new (): T;
    (): T;
    readonly proptotype: Function;
} : never;
...
declare const TeleportImpl: {
    ...
    process(n1: VNode<RendererNode, RendererElement> | null, n2: VNode<RendererNode, RendererElement>, container: RendererElement, anchor: RendererNode | null, parentComponent: ComponentInternalInstance | null, parentSuspense: SuspenseBoundary | null, isSVG: boolean, optimized: boolean, internals: RendererInternals<RendererNode, RendererElement>): void;
    remove(vnode: VNode<RendererNode, RendererElement>, { r: remove, o: { remove: hostRemove } }: RendererInternals<RendererNode, RendererElement>): void;
