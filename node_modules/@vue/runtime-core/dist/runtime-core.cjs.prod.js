...
function resolvePropValue(options, props, key, value) {
    ...
    if (opt != null) {
        ...
        if (hasDefault && value === undefined) {
            ...
            value = shared.isFunction(defaultValue) ? defaultValue() : defaultValue;
        }
        // boolean casting
        if (opt[0 /* shouldCast */]) {
...
function normalizePropsOptions(raw) {
    ...
    shared.def(raw, '_n', normalizedEntry);
...
const PublicInstanceProxyHandlers = {
    get({ _: instance }, key) {
        ...
        if (key[0] !== '$') {
            ...
            // props
            type.props &&
                shared.hasOwn(normalizePropsOptions(type.props)[0], key)) {
    ...
    has({ _: { data, setupState, accessCache, ctx, type, appContext } }, key) {
        return (accessCache[key] !== undefined ||
            ...
            (type.props && shared.hasOwn(normalizePropsOptions(type.props)[0], key)) ||
